...
\item \bf{Tree Pruning:}  XGBoost uses max\_depth parameter as specified the stopping criteria for the splitting of the branch, and starts pruning trees backward. This depth-first approach improves computational performance significantly.
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=.5]{0-LEVEL DFD}
\caption{0-level DFD}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=.5]{1-LEVEL DFD}
\caption{1-level DFD}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=.5]{2- LEVEL DFD}
\caption{2-level DFD}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=.3]{Activity diagram}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=.4]{Class diagram}
...
\begin{steps}
  \item \textbf{Login:} Login to the campus placement assistant website by signing up with email or using google for sign in .
  \item \textbf{:}
\end{steps}
\newpage
\begin{flushleft}\textbf{CHAPTER 8} \end{flushleft}
